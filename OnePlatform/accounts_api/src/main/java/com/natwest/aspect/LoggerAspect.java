...
public class LoggerAspect {
	...
	@Before(value = "execution(* com.natwest.controller.AccountsController.addAccounts(..))")
	...
	@After(value = "execution(* com.natwest.controller.AccountsController.addAccounts(..))")
	...
	@AfterThrowing(value = "execution(* com.natwest.controller.AccountsController.addAccounts(..))", throwing = "e")
	public void logAfterAddTransExceptionOccured(JoinPoint joinPoint, Throwable e) {
		log.info("****** Exception occured *********");
		log.error(e.getMessage());
	}
	
	@AfterThrowing(value = "execution(* com.natwest.controller.AccountsController.getAllAccountsByCustomerId(..))", throwing = "e")
	...
	@Around(value = "execution(* com.natwest.controller.AccountsController.addAccounts(..))")
	...
	//this will be injected when the method is executed
		@Around(value = "execution(* com.natwest.controller.AccountsController.getAllAccountsByAccountTypeAndCustomerId(..))")
